...
เว็บจัดการกลุ่ม YouTube Premium สำหรับแอดมิน 1 คน และหน้าลูกค้าที่เข้าด้วยรหัสจากร้าน

## โครงระบบ

- `Vercel` ใช้โฮสต์หน้าเว็บ
- `Supabase Database` เก็บกลุ่ม, User, สมาชิก, ประกาศ, โปรโมชั่น
...
- กลุ่ม
- User ลูกค้าและรหัสเข้าใช้งาน
- ผูก User กับกลุ่มที่เห็นได้
- สมาชิกในกลุ่ม
...
ลูกค้ากรอกรหัสที่ร้านให้ แล้วเห็นเฉพาะกลุ่มที่แอดมินกำหนดไว้
